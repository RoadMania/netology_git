...
С помощью git делаю небольшой фикс и с указанием тега пуляю изменения в репу. Это сразу же триггерит наш пайплайн. Как итог - успешное обновление кластера:

<img src="https://github.com/RoadMania/netology_git/blob/main/Diploma/screens/diploma27_1.JPG"> </div> <br>
